...
let workbook = XLSX.readFile("../../rawData/2015_2/lessons.xlsx");
...
//This procedure checks every 9 cells for all rows.
let columns = ["A", "B", "C", "D", "E", "F", "G", "H", "I"];
let lessons = [];
for (let rows = 2; rows <= 584; rows++) {
	let tempArray = [];
...
setTimeout(() => {
	fs.writeFileSync(
		"../../processedData/2015_2/parsedLessons.json",
